            ...
            <div className="flex items-center gap-2.5">
              ...
              {isCompleted && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/40 text-xs font-semibold transition font-mono"
                  title="Rate this Pipeline Execution Experience"
                >
                  <Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
                  <span>Rate Execution ⭐</span>
                </button>
              )}
            </div>
          </div>
